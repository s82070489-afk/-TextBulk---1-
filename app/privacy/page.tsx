...
const articles = [
  ...
  },
  {
    id: 2,
    title: "수집 항목",
    summary: "본 사이트는 회원가입이 없으며, 어떠한 사용자 콘텐츠 데이터도 수집·저장하지 않습니다.",
    items: [
      { label: "이미지 및 텍스트 데이터", value: "수집하지 않음 (서버 전송 원천 차단)" },
      { label: "회원 가입 및 이메일 정보", value: "수집하지 않음 (계정 체계 없음)" },
      { label: "IP 주소", value: "서버 로그를 통해 자동 수집될 수 있음 (비식별 통계용)" },
  ...
  },
  {
    ...
    title: "처리 목적",
    items: [
      "웹사이트 서비스의 안정적 운영 및 트래픽 모니터링",
      "방문자 통계 분석 및 서비스 품질 개선",
      "부정 이용 방지 및 시스템 보안 유지",
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    title: "보유 및 파기",
    content: [
      "이용자의 이미지, 텍스트 등 콘텐츠 데이터는 서버에 보관 자체가 되지 않으므로 별도의 보유·파기 절차가 존재하지 않습니다.",
      "운영 및 통계 목적으로 자동 수집되는 비식별 접속 로그는 최대 12개월간 보관 후 영구 파기합니다.",
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    title: "안전성 확보 조치",
    items: [
      "클라이언트 사이드 전용 아키텍처로 사용자 데이터의 외부 유출 가능성 원천 차단",
      "HTTPS(SSL/TLS) 보안 암호화 통신 적용",
  ...
  },
  {
    ...
    title: "오류 제보 및 문의 창구",
    content: [
      "서비스 이용 중 발생하는 시스템 오류 제보, 기능 개선 제안 또는 본 방침에 대한 문의는 아래의 이메일 창구를 이용해 주시기 바랍니다. 발송하신 문의 메일은 답변 완료 후 지체 없이 파기됩니다."
    ],
    contact: {
